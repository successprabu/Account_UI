        ...
        <Container>
          ...
          <Row className="mt-4">
            <Col md={12}>
              ...
              <ul>
                ...
                <li>
                  <strong>{t("Customer-Centricity")}</strong>:{" "}
                  {t(
                ...
                <Col md={4}>
                  <Card>
                    <Card.Body>
                      ...
                      <Card.Text>
                        {t(
                          "[Brief bio highlighting their experience and expertise]"
                        )}
                      </Card.Text>
                    </Card.Body>
                  </Card>
          ...
          <Row className="mt-4">
            <Col md={12}>
              ...
              <p>
                {t(
                  "Founded in [Year], [Your Company Name] has grown from a small startup into a leading provider of [your services]. Our journey is marked by milestones that reflect our commitment to innovation and client satisfaction. Explore our timeline to see how we have evolved over the years."
                )}
              </p>
            </Col>
          </Row>
