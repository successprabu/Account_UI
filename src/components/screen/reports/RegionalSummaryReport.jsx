...
import {  REPORT_GET_GENERALDATA_API ,REPORT_GET_REGIONALSUMMARY_API} from "../../common/CommonApiURL";
...
const RegionalSummaryReport = () => {
  ...
  const DownloadPDF = async () => {
    ...
    const pdfHeight = pdf.internal.pageSize.getHeight();
      ...
      // Save the PDF
      pdf.save("Regional_Summary_Report.pdf");
    } catch (error) {
